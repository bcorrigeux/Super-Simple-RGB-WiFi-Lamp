...
const char websiteSource[] PROGMEM =
  ...
  "            }\n"
  "            if (\"Alarm\" in jsonMessage) {\n"
  "                // console.log(\"Found Alarm Message\")\n"
  "                handleAlarmMessage(jsonMessage[\"Alarm\"])\n"
  "            }\n"
  ...
  "        }\n"
  "\n"
  "        function handleAlarmMessage(jsonMessage) {\n"
  "            if (typeof jsonMessage === \"object\") {\n"
  "                var newRed = currentRed\n"
  "                var newGreen = currentGreen\n"
  "                var newBlue = currentBlue\n"
  ...
  "                    }\n"
  "                }\n"
  "                if ((\"startTime\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.startTime === \"number\") {\n"
  "                        newStartTime = jsonMessage.startTime\n"
  "                    }\n"
  "                }\n"
  "                if ((\"endTime\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.endTime === \"number\") {\n"
  "                        newEndTime = jsonMessage.endTime\n"
  "                    }\n"
  "                }\n"
  "                if ((\"startBrightness\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.startBrightness === \"number\") {\n"
  "                        newStartBrightness = jsonMessage.startBrightness\n"
  "                    }\n"
  "                }\n"
  "                if ((\"endBrightness\" in jsonMessage)) {\n"
  "                    if (typeof jsonMessage.endBrightness === \"number\") {\n"
  "                        newEndBrightness = jsonMessage.endBrightness\n"
  "                    }\n"
  "                }\n"
  "\n"
  "                setPickerColor(colourSelectButton, newRed, newGreen, newBlue)\n"
  ...
  "                    </li>\n"
  "                    <li id=\"alarmTabNavItem\" class=\"nav-item\">\n"
  "                        <a class=\"nav-link\" data-toggle=\"tab\" href=\"#Alarm\">Alarm</a>\n"
  "                    </li>\n"
  ...
  "                    });\n"
  "                    $(\"#alarmTabNavItem\").click(function () {\n"
  "                        sendMessage({ \"Mode\": \"Alarm\" })\n"
  "                    });\n"
  "                </script>\n"
  "            </div>\n"
  "        </div>\n"
  ...
  "            <button id=\"alarmButton\" type=\"submit\" class=\"col mb-2 mx-2 btn btn-lg btn-outline-light\">Alarm</button>\n"
  ...
  "                    $('#navbarHeader a[href=\"#Alarm\"]').tab('show')\n"
  "                    sendMessage({ \"Mode\": \"alarm\" })\n"
  "                });\n"
  ...
  "            </script>\n"
  "        </div>\n"
  "        <div id=\"Alarm\" class=\"container pb-5 tab-pane fade\">\n"
  "            <h2>Alarm Mode</h2>\n"
  "            <p>This will set a sunrise alarm for the next day</p>\n"
  "\n"
  "            <div class=\"row my-3\">\n"
  "                <input id=\"colourSelectButton\" class=\"color col mb-2 mx-2 btn btn-lg btn-outline-light\" value=\"rgb(0,0,0)\"></input>\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"startHour\"><b>start Hour</b>: <span id=\"startHourLabel\">8</span>Hr</label>\n"
  "                <input id=\"startHour\" type=\"range\" min=\"0\" max=\"24\" step=\"1\" value=\"8\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"startMinute\"><b>start Minute</b>: <span id=\"startMinuteLabel\">0</span>Min</label>\n"
  "                <input id=\"startMinute\" type=\"range\" min=\"0\" max=\"60\" step=\"5\" value=\"0\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"endHour\"><b>end Hour</b>: <span id=\"endHourLabel\">8</span>Hr</label>\n"
  "                <input id=\"endHour\" type=\"range\" min=\"0\" max=\"24\" step=\"1\" value=\"8\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"endMinute\"><b>end Minute</b>: <span id=\"endMinuteLabel\">0</span>Min</label>\n"
  "                <input id=\"endMinute\" type=\"range\" min=\"0\" max=\"60\" step=\"5\" value=\"1\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"startBrightness\"><b>start Brightness</b>: <span id=\"startBrightnessLabel\">10</span>%</label>\n"
  "                <input id=\"startBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"10\" value=\"10\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div>\n"
  "                <label for=\"endBrightness\"><b>end Brightness</b>: <span id=\"endBrightnessLabel\">80</span>%</label>\n"
  "                <input id=\"endBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"10\" value=\"80\" class=\"form-control-range custom-range\">\n"
  "            </div>\n"
  "            <div class=\"row my-3\">\n"
  "                <button id=\"Set\" class=\"col mb-2 mx-2 btn btn-lg btn-outline-light\">Set Alarm</button>\n"
  "            </div>\n"
  "            <script>\n"
  "                var currentRed = 0;\n"
  "                var currentGreen = 0;\n"
  ...
  "                });\n"
  "\n"
  "                $(\"#startBrightness\").on(\"input\", function () {\n"
  "                    onVisualiserEvent()\n"
  "                });\n"
  "                $(\"#startBrightness\").on(\"change\", function () {\n"
  "                    onVisualiserEvent()\n"
  "                });\n"
  "                $(\"#endBrightness\").on(\"input\", function () {\n"
  "                    onVisualiserEvent()\n"
  "                });\n"
  "                $(\"#endBrightness\").on(\"change\", function () {\n"
  "                    onVisualiserEvent()\n"
  "                });\n"
  "\n"
  "                $(\"#Set\").click(function () {\n"
  ...
  "                    let startBrightness = parseInt($(\"#startBrightness\").val(), 10)\n"
  "                    let endBrightness = parseInt($(\"#endBrightness\").val(), 10)\n"
  "\n"
  "                    $(\"#startHourLabel\").html(startHour)\n"
  "                    $(\"#startMinuteLabel\").html(startMinute)\n"
  "                    $(\"#endHourLabel\").html(endHour)\n"
  "                    $(\"#endMinuteLabel\").html(endMinute)\n"
  "                    $(\"#startBrightnessLabel\").html(startBrightness)\n"
  "                    $(\"#endBrightnessLabel\").html(endBrightness)\n"
  "\n"
  "                    msg = {\n"
  "                        \"State\": true,\n"
  "                        \"Mode\": \"Alarm\",\n"
  "                        \"Alarm\": {\n"
  "                            \"startTime\": startMinute + 60 * startHour,\n"
  "                            \"endTime\": endMinute + 60 * endMinute,\n"
  ...
  "                        }\n"
  "                    }\n"
  "                    if (Date.now() - setDebounce > 50) {\n"
  "                        setDebuonce = Date.now()\n"
  "                        sendMessage(msg)\n"
  "                    }\n"
  "                }\n"
  "\n"
